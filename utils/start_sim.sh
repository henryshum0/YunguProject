...
#
# Usage:
#   ./start_sim.sh                                   # defaults from src/simulation/config/simulation.yaml
...
#
# Model, map, GZ version and uXRCE port default to src/simulation/config/simulation.yaml
...
# Read the simulation defaults from src/simulation/config/simulation.yaml. Environment
