...
namespace super_planner {
    ...
    class SuperPlanner {
        ...
        std::atomic_bool near_goal_braking_active_{false};
    ...
    public:
        ...
        /// True while the one-shot near-goal braking trajectory remains the
        /// committed command. Its final zero-velocity point is intentionally
        /// held rather than regenerated by the FSM.
        bool isNearGoalBrakingActive() const {
            return near_goal_braking_active_.load();
        }
