...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  // Generic handler for clouds without ring/time fields (e.g. Gazebo
  // instantaneous scans): reads only x/y/z/intensity, no deskew.
  void default_handler(const sensor_msgs::msg::PointCloud2::UniquePtr &msg, const int &lidar_num);
};
