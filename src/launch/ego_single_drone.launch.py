...
def _nodes(context):
    ...
    ego_parameters = {
        ...
        "grid_map/obstacle_ttl_sec": ego["obstacle_ttl_sec"],
        "grid_map/p_hit": ego["occupancy_hit_probability"],
        "grid_map/p_miss": ego["occupancy_miss_probability"],
        "grid_map/p_min": ego["occupancy_min_probability"],
        "grid_map/p_max": ego["occupancy_max_probability"],
        "grid_map/p_occ": ego["occupancy_probability_threshold"],
